      ...
      <div>
        <div className={Resultstyles.resultPath}>
          ...
          {this.props.paths.length !== 0 ? (
            <div>
              <div className={Resultstyles.filterCard}>
                <h4>
                  Sort by: <span style={{ marginLeft: "10px" }}> Votes </span>
                </h4>
                <div className={Resultstyles.filterArrowContainer}>
                  <img
                    className={Resultstyles.filterArrow}
            ...
            <div className={Resultstyles.noResults}>No Paths Found</div>
          )}
        </div>

        <div className={Resultstyles.resultFootsteps}>
          <h1>Footsteps ({this.props.footsteps.length})</h1>
          <Row>
            {this.props.footsteps.length !== 0 ? (
              <div>
                <div className={Resultstyles.filterCardFootsteps}>
                  <h4>
              ...
              <div className={Resultstyles.noResults}>No Footsteps Found</div>
            )}
          </Row>
        </div>
      </div>
